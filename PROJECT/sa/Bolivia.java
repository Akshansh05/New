...
mi=minutes;
obg.func2();
System.out.println("\f"+"The time in Bolivia is "+ho+" hours "+mi+" minutes ");
System.out.println();
Thread.sleep(1000);
if(ho>12)
{ho=ho-12;
...
System.out.println("The time in Bolivia according to Indian watch is "+ho+" hours "+mi+" minutes "+g); 
System.out.println();
Thread.sleep(1000);
...
a="NOON";
 ...
 System.out.println("The time in Bolivia  according to Indian watch is "+ho+" hours "+mi+" minutes "+a); 
 System.out.println();
 Thread.sleep(1000);
