...
mi=minutes;
obg.func2();
System.out.println("\f"+"The time in Victoria is "+ho+" hours "+mi+" minutes ");
System.out.println();
 Thread.sleep(1000);
System.out.println("The time in Victoria according to Indian watch is "+ho+" hours "+mi+" minutes  A.M"); 
System.out.println();
 Thread.sleep(1000);
...
a="NOON";
 ...
 System.out.println("The time in Victoria according to Indian watch is "+ho+" hours "+mi+" minutes "+a); 
 System.out.println();
  Thread.sleep(1000);
 for( ii=0;ii<E.length;ii++)
