...
obg.func2();
System.out.println("\f"+"The time in Adelaide is "+ho+" hours "+mi+" minutes ");
System.out.println();
System.out.println("The time in Adelaide according to Indian watch is "+ho+" hours "+mi+" minutes  A.M"); 
System.out.println();
...
a="NOON";
 ...
 System.out.println("The time in Adelaide according to Indian watch is "+ho+" hours "+mi+" minutes "+a); 
 System.out.println();
 for( ii=0;ii<E.length;ii++)
